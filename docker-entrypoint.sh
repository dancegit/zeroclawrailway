...
setup_kokoro_tts() {
    ...
    KOKORO_TIMEOUT="${ZEROCLAW_KOKORO_TIMEOUT:-1200}"
...
shell_env_passthrough = [
    ...
    "MEMCODE_API_URL",
    "MEMCODE_API_KEY",
    "MEMCODE_DEFAULT_USER",
    "MEMCODE_DEFAULT_EMAIL",
    "MEMCODE_DEFAULT_PASSWORD",
    "MEMCODE_DEFAULT_COURSE_ID",
    "MEMCODE_SITE_USERNAME",
    "MEMCODE_SITE_PASSWORD"
]
